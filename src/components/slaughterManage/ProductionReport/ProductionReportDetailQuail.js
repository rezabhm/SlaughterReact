...
class ProductionReportDetailQuail extends Component {
        ...
        return (
            <div className="App" style={{
                ...
                overflow:'scroll',
                    ...
                    <Header title=' گزارش گیری ریز تولید (واحد بلدرچین)' rightDashboardButton={this.state.RightDashbord} rightDashboardClickButton={this.rightDashboardButtonClick} />
...
export default withCookies(ProductionReportDetailQuail);