...
class ProductionReportGeneralTurkey extends Component {
        ...
        return (
            <div className="App" style={{
                ...
                overflow:'scroll',
                    ...
                    <Header title=' گزارش گیری تولید (واحد بوقلمون)' rightDashboardButton={this.state.RightDashbord} rightDashboardClickButton={this.rightDashboardButtonClick} />
...
export default withCookies(ProductionReportGeneralTurkey);
