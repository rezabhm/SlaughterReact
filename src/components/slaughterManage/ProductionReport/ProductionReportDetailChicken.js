...
class ProductionReportDetailChicken extends Component {
        ...
        return (
            <div className="App" style={{
                ...
                overflow:'scroll',
                    ...
                    <Header title=' گزارش گیری ریز تولید (واحد مرغ)' rightDashboardButton={this.state.RightDashbord} rightDashboardClickButton={this.rightDashboardButtonClick} />
...
export default withCookies(ProductionReportDetailChicken);