...
class ProductionReportGeneralQuail extends Component {
        ...
        return (
            <div className="App" style={{
                ...
                overflow:'scroll',
                    ...
                    <Header title=' گزارش گیری تولید (واحد بلدرچین)' rightDashboardButton={this.state.RightDashbord} rightDashboardClickButton={this.rightDashboardButtonClick} />
...
export default withCookies(ProductionReportGeneralQuail);
